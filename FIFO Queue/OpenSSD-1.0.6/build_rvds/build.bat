...
armlink --via=armlink_opt.via init.o ftl.o sata_identify.o sata_cmd.o sata_isr.o sata_main.o sata_table.o mem_util.o flash.o flash_wrapper.o initialize.o misc.o uart.o
