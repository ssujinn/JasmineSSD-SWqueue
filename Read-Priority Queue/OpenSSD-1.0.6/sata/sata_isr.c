...
static __inline void handle_got_cfis(void)
{
	...
	/*
	{
		uart_print("-------Command Get-------\n");
		uart_print("SATA_FIS_0 :"); uart_print_hex(GETREG(SATA_FIS_H2D_0));
		uart_print("SATA_FIS_1 :"); uart_print_hex(GETREG(SATA_FIS_H2D_1));
		uart_print("SATA_FIS_2 :"); uart_print_hex(GETREG(SATA_FIS_H2D_2));
		uart_print("SATA_FIS_3 :"); uart_print_hex(GETREG(SATA_FIS_H2D_3));
		uart_print("SATA_FIS_4 :"); uart_print_hex(GETREG(SATA_FIS_H2D_4));
	}
	*/
...
//			uart_printf("HW insert> lba: %d / sect: %d / cmd:  %d", lba, sector_count, cmd_type); 
		}
		else
		{
